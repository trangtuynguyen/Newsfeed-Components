...
function createArticle(tle, dte, ctn1, ctn2, ctn3){
  ...
  //assign paramenter to elements as value
  title.textContent = tle;
  date.textContent = dte;
  content1.textContent = ctn1;
  content2.textContent = ctn2;
  content3.textContent = ctn3;
  btn.textContent = "expand";

  //add class to the date
  date.classList.add('date');
  //add class to article object
